...
# Ignored inside `<out>/.gitignore`: per-run scratch and per-run reports. `finalize-report.*` is
...
_GITIGNORE_KEEP: tuple[str, ...] = ("build-fragments/", "finalize-report.json", "finalize-report.md")
