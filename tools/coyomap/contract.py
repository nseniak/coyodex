...
_USAGE = ("usage: coyomap contract <" + " | ".join(CONTRACTS) + "> [--slots]\n"
          ...
          "  coyomap contract harvest --slots > slots.json          # fill the values, then:\n"
          "  coyomap contract harvest --fill slots.json \\\n"
          "                           --out /abs/scratch/h1.md --brief h1\n\n"
          "Without --fill it writes the unfilled agent half to stdout:\n"
          "  coyomap contract harvest > <scratch>/harvest-contract.md\n\n"
