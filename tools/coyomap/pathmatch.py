...
Two features match repo-relative paths against author-written globs: `coyomap reconcile`
(`source_glob` rules) and the analysis ignore file (`.coyomap/.ignore`). They want the same
