...
demand from the model), and `coyodex export` writes that same viewer out as a folder of plain files
for anyone to host — how a map is shared with people who have neither the repo nor coyodex. Record
