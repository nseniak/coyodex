...
| **C20** | Command line | S30 | Routes each typed coyomap command to the tool that runs it. The same layer decides how much of a long finding list a reader sees. | [cli.py](tools/coyomap/cli.py:139) |  | verified | tools/coyomap/cli.py · tools/coyomap/subverb_help.py · tools/coyomap/reporting.py | coyomap command line |
...
| **C80** | Map rendering | S40 | Turns a stored map into the readable file kept beside the code. Also builds the boxes and arrows the browser draws. | [render.py](tools/coyomap/viewer/render.py:22) |  | verified | tools/coyomap/views.py · tools/coyomap/viewer/render.py | coyomap command line, Map server |
...
| **C83** | Map server | S41 | Serves every map on this machine at a local web address. Reads a project's own code from its version history. | [serve.py](tools/coyomap/viewer/serve.py:919) |  | verified | tools/coyomap/viewer/serve.py · tools/coyomap/viewer/diffmap.py | Map server |
