...
Change (2026-09-09): `coyomap contract tests` ships the test-completeness contract (slots
`COYOMAP_HOME`, `REPO`, `MAP`, `PROJECT`, `TESTS_ARE`, `AGENT_ID`; the writing rules appended,
