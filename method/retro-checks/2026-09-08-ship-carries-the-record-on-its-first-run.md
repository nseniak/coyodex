...
Change (2026-09-08): `tools/coyomap/ship.py` names `build-fragments/grounding.json` in the two
...
1. expect: after the first `ship` FINISH run that exits 0, `.coyomap/project-map.json` carries a
