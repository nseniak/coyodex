...
`coyomap contract harvest-t5 >> <that agent's brief>`, AFTER the filled harvest contract. It moved
...
> see [domain-cards.md](«COYOMAP_HOME»/method/domain-cards.md). Mark plumbing types you
