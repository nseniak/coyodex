...
name: coyomap-retro
description: >
  FOR THE COYOMAP DEVELOPER, not for users of coyomap: run a retrospective on a coyomap
  ...
  build", "find bugs from the last coyomap run", "retro the map build", or runs /coyomap-retro.
  Triggers on "coyomap-retro", "build retrospective", "review the coyomap run".
---
...
Read `__COYOMAP_HOME__/eval/retro/method.md` and follow it end to end. It is the entry point, and it names every
