#!/usr/bin/env python3
"""`coyomap-eval walk-score` — score a partial run of the front-door walk against a gold answer.
...
USAGE = """usage: coyomap-eval walk-score <before> <after> --gold <gold.json> [--json]

<before> and <after> are a map file or a `.coyomap/` directory. The gold is `{"EPn": [outcome, ...]}`:
