"""Handler for the Metrics rollup plugin.
...
class MetricsHandler:
    ...
    def handle(self, body: dict[str, Any]) -> dict[str, Any]:
        ...
        self._analytics.enqueue("metrics.handled", payload.get("tenant", "unknown"))
        return payload
    ...
    def describe(self) -> str:
        return "Metrics rollup plugin listening on " + CHANNEL
