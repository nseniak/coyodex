"""Handler for the Outbound webhook plugin.
...
class WebhookHandler:
    ...
    def handle(self, body: dict[str, Any]) -> dict[str, Any]:
        ...
        self._analytics.enqueue("webhook.handled", payload.get("tenant", "unknown"))
        return payload
    ...
    def describe(self) -> str:
        return "Outbound webhook plugin listening on " + CHANNEL
